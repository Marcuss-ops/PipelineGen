...
func calculateQualityScore(transcript, title, description string, tags []string, duration float64, meta *types.ClipRichMetadata) float64 {
...
func calculateHeuristicQualityScore(transcript, title, description string, tags []string, duration float64, meta *types.ClipRichMetadata) float64 {
	score := 0.08
