...
func NewService(deps SearchDeps) *Service {
	return &Service{
...
func (s *Service) GetVideoInfo(ctx context.Context, videoURL string) (*ports.DownloaderMetadata, error) {
	if videoURL == "" {
...
func (s *Service) getCachedVideoMetadata(ctx context.Context, videoID string) (*ports.DownloaderMetadata, bool) {
	if s.cache == nil {
		return nil, false
	}
...
func (s *Service) setCachedVideoMetadata(ctx context.Context, videoID string, metadata *ports.DownloaderMetadata) {
	if s.cache == nil {
		return
	}
