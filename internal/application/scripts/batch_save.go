...
func (s *BatchService) saveBatchScript(ctx context.Context, req *GenerateBatchRequest, rec *batchDBRecord, researchSources []ScriptResearchSource) int64 {
	...
	scriptID, saveErr := s.scriptsRepo.SaveScript(ctx, &ScriptRecord{
		Topic:          rec.docTitle,
		Title:          rec.docTitle,
