...
func mergeBatchResults(docTitle string, results []*genChapterResult, noChapters bool, language string) ([]GeneratedPart, string, []chapterTiming, []ScriptSectionRecord) {
