...
//
// PR-A (June 2026): tests BatchService persistence directly.
// PR7 (June 2026): removed GenerateBatchUseCase wrapper — tests
// now exercise BatchService.saveBatchScript directly.
package scripts
