...
//
//	internal/application/assets/delivery/registry.go            // FACCIATA (this file)
//	internal/application/assets/delivery/registry_lifecycle.go  // the policy table
//	internal/application/assets/delivery/registry_transport.go  // the per-destination path builders
//
