...
// NewDriveValidatorMetrics constructs the production metrics
// struct backed by the package-level promauto globals. The
// returned pointer is stable across calls — the fields point at
// the same promauto collectors every caller sees, so increments
// accumulate on the default registry as expected.
