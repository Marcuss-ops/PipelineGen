// Package stockpipeline — interleave.go (moved from the legacy planner.go,
// August 2026).
//
// InterleaveClips is a render-ordering utility, not part of the ClipPlanner
// contract. It lived in the legacy stockpipeline/planner.go alongside the
// duplicated planner implementations; those duplicates are now owned solely
// by types/planner.go, so this utility gets its own home.
