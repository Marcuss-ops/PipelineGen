...
func (s *DriveStager) StageSourceV2(ctx context.Context, ref assets.SourceRef) (*assets.StagedSource, error) {
	return nil, fmt.Errorf("%w: url=%q", ErrDriveStagerNotImplemented, ref.URL)
}
...
func (s *DriveStager) CleanupStagedSource(ctx context.Context, staged *assets.StagedSource) error {
	if staged == nil {
		return nil
	}
