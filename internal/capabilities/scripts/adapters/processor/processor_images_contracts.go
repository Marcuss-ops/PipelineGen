...
// strings; Process() iterates and maps to adapters.PostProcessResult.StageWarnings.
//
...
//	             is Succeeded; zero-valued adapters.SceneImage otherwise).
