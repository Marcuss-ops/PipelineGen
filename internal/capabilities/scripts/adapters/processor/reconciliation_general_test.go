...
func TestAssetLocationReconciliation_NilVerifierError(t *testing.T) {
	...
	_, err := p.Process(context.Background(), nil, adapters.ProcessInput{
...
func TestAssetLocationReconciliation_MissingVerifierStopsDownstreamPublication(t *testing.T) {
	...
	registry := adapters.NewPostProcessorRegistry(nil)
	...
	}, adapters.ProcessInput{SpecScene: scriptpkg.SpecSceneOutput{
		Version: 1,
...
func TestAssetLocationReconciliation_EmptyScenes(t *testing.T) {
	...
	got, err := p.Process(context.Background(), nil, adapters.ProcessInput{
