...
func TestAssetLocationReconciliationStockMissingLinkUsesAssetID(t *testing.T) {
	...
	got, err := NewAssetLocationReconciliationProcessor(r).Process(context.Background(), nil, adapters.ProcessInput{
...
func TestAssetLocationReconciliationStockCanonicalURLAndQuery(t *testing.T) {
	...
	_, err := NewAssetLocationReconciliationProcessor(r).Process(context.Background(), nil, adapters.ProcessInput{
...
func TestAssetLocationReconciliationStockKeepsFolderID(t *testing.T) {
	...
	got, err := NewAssetLocationReconciliationProcessor(r).Process(context.Background(), nil, adapters.ProcessInput{SpecScene: scriptpkg.SpecSceneOutput{Scenes: []scriptpkg.SpecScene{scene}}})
	if err != nil {
		t.Fatal(err)
	}
