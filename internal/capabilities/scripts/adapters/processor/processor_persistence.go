...
func (p *PersistenceProcessor) Name() adapters.ProcessorName { return adapters.ProcessorPersistence }

// Policy classifies persistence as adapters.ProcessorRequired: a missing-registered
...
func (p *PersistenceProcessor) Policy(_ *scriptpkg.ResolvedGenerationPlan) adapters.ProcessorPolicy {
	return adapters.ProcessorRequired
}

func (p *PersistenceProcessor) Process(ctx context.Context, plan *scriptpkg.ResolvedGenerationPlan, input adapters.ProcessInput) (*adapters.PostProcessResult, error) {
	if p.repo == nil {
...
func originalSpecSceneForPersistence(input adapters.ProcessInput) scriptpkg.SpecSceneOutput {
...
func (p *PersistenceProcessor) persistSourceLanguageRow(ctx context.Context, plan *scriptpkg.ResolvedGenerationPlan, input adapters.ProcessInput) (int64, error) {
