...
//     (PostProcess path; adapters.ProcessorPolicy = BestEffort — failures
...
// processor's adapters.ProcessorBestEffort policy is the source of truth for
...
// adapters.ProcessorBestEffort semantics: each failure surfaces as a
