...
func TestMetadataProcessor_NilGenerator_ReturnsErrPostprocessFailed(t *testing.T) {
	...
	input := adapters.ProcessInput{Text: "Test script body"}
...
func TestMetadataProcessor_ManualMetadata_WorksWithoutGenerator(t *testing.T) {
	...
	got, err := p.Process(context.Background(), plan, adapters.ProcessInput{})
	if err != nil {
...
func TestMetadataProcessor_UsesAIFallbackWhenManualMetadataAbsent(t *testing.T) {
	...
	got, err := p.Process(context.Background(), plan, adapters.ProcessInput{Text: "Script body"})
	if err != nil {
...
func TestMetadataProcessor_UsesAIFallbackOncePerLanguage(t *testing.T) {
	...
	result, err := processor.Process(
		context.Background(),
		plan,
		adapters.ProcessInput{Text: "Script body"},
	)
	if err != nil {
		t.Fatalf("AI fallback returned an error: %v", err)
	}
