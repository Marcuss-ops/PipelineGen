...
func (p *NarrationSanitizer) Name() adapters.ProcessorName {
	return adapters.ProcessorNarrationSanitizer
}

func (p *NarrationSanitizer) Policy(_ *scriptpkg.ResolvedGenerationPlan) adapters.ProcessorPolicy {
	return adapters.ProcessorRequired
}

func (p *NarrationSanitizer) Process(_ context.Context, _ *scriptpkg.ResolvedGenerationPlan, input adapters.ProcessInput) (*adapters.PostProcessResult, error) {
