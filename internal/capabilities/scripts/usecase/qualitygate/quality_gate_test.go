...
func TestEvaluateQualityGate_PassesCleanGeneration(t *testing.T) {
	...
	quality, err := Evaluate(result, item, plan)
	if err != nil {
...
func TestEvaluateQualityGate_RejectsCrossBoxerSegmentText(t *testing.T) {
	...
	quality, err := Evaluate(result, scriptpkg.GenerationItemV2{ID: "boxers"}, scriptpkg.ResolvedGenerationPlan{Segments: segments})
...
func TestEvaluateQualityGate_AllowsShortClipIntroduction(t *testing.T) {
	...
	quality, err := Evaluate(result, scriptpkg.GenerationItemV2{ID: "margot-clip"}, plan)
	if err != nil {
...
func TestEvaluateQualityGate_SourceAbsentIsNotEvaluated(t *testing.T) {
	...
	quality, err := Evaluate(result, scriptpkg.GenerationItemV2{ID: "no-source"}, scriptpkg.ResolvedGenerationPlan{Language: "en"})
	if err != nil {
...
func TestEvaluateQualityGate_TextUnsupportedClaimsAreDiagnostic(t *testing.T) {
	...
	quality, err := Evaluate(result, scriptpkg.GenerationItemV2{ID: "item-9"}, plan)
	if err != nil {
