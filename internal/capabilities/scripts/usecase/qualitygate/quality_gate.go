// Package qualitygate — quality_gate.go implements the editorial quality
// gate for /api/script/generate.
//
// The package was extracted from internal/capabilities/scripts/usecase
// (2026-09-12) to keep the usecase package under the package-size
// ceiling: the gate is a self-contained rule registry with no
// dependency on the usecase package, so it now lives behind its own
// package boundary. Evaluate is the single entry point.
//
...
// Evaluate computes the editorial quality metrics for a
