...
//   - internal/capabilities/jobs/worker.go (Worker.NewWorker takes
//     a QueueNotifier arg + subscribes via port.Subscribe for
//     in-process wake on Enqueue)
//   - internal/capabilities/jobs/queue/lifecycle_job_runner.go
//     (RunnerConfig.Notifier wires the composition-root SQLiteStore)
//   - internal/capabilities/jobs/queue/types.go (RunnerConfig carries the
