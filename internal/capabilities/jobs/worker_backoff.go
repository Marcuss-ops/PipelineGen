...
// BackoffConfig is retained as an application compatibility alias. The
// scheduling package owns the polling configuration contract.
type BackoffConfig = jobscheduling.BackoffConfig
