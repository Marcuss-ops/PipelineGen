...
//
// See internal/capabilities/jobs/worker/runner.go::postRenewFailClosedCheck
...
// stubLeaseBroker is the mock jobs.Broker used by the P0 #5
...
func (b *stubLeaseBroker) RegisterWorker(_ context.Context, _ jobs.RegisterWorkerCommand) (*jobs.WorkerSession, error) {
...
func (b *stubLeaseBroker) Heartbeat(_ context.Context, _ jobs.HeartbeatCommand) error {
	return nil
}

func (b *stubLeaseBroker) Claim(_ context.Context, _ jobs.ClaimCommand) (*jobs.Lease, error) {
	return &jobs.Lease{
		Job: &job.Job{
			ID:       "renew-fail-job",
...
func (b *stubLeaseBroker) Renew(_ context.Context, _ jobs.RenewCommand) (*jobs.Lease, error) {
...
func (b *stubLeaseBroker) Progress(_ context.Context, _ jobs.ProgressCommand) error {
	return nil
}

func (b *stubLeaseBroker) Complete(_ context.Context, _ jobs.CompleteCommand) error {
	atomic.AddInt32(&b.completeCalls, 1)
	return nil
}

func (b *stubLeaseBroker) CompleteWithArtifacts(_ context.Context, _ jobs.CompleteWithArtifactsCommand) ([]string, error) {
	atomic.AddInt32(&b.completeCalls, 1)
	return nil, nil
}

func (b *stubLeaseBroker) Fail(_ context.Context, _ jobs.FailCommand) error {
...
// guards against future drift of the jobs.Broker interface
...
var _ jobs.Broker = (*stubLeaseBroker)(nil)
...
func TestRunLease_RenewalError_NoCompleteCall(t *testing.T) {
	...
	handler := func(ctx context.Context, _ *job.Job, _ *jobs.JobExecutionTools) (jobs.Result, error) {
		...
		// must consume *jobs.JobExecutionTools (==*domainob.JobExecutionTools)
		// AND return jobs.Result (==Map alias). The worker runtime
...
func (b *azione7Broker) RegisterWorker(_ context.Context, _ jobs.RegisterWorkerCommand) (*jobs.WorkerSession, error) {
	return nil, nil
}
func (b *azione7Broker) Heartbeat(_ context.Context, _ jobs.HeartbeatCommand) error { return nil }
func (b *azione7Broker) Claim(_ context.Context, _ jobs.ClaimCommand) (*jobs.Lease, error) {
	return &jobs.Lease{
		Job: &job.Job{
			ID:       "azione7-job",
			Type:     "azione7.test",
...
func (b *azione7Broker) Renew(_ context.Context, _ jobs.RenewCommand) (*jobs.Lease, error) {
	return &jobs.Lease{Job: &job.Job{Revision: 2, LeaseID: "lease-1", ID: "azione7-job", Type: "azione7.test"}, LeaseID: "lease-1"}, nil
}
func (b *azione7Broker) Progress(_ context.Context, _ jobs.ProgressCommand) error { return nil }
func (b *azione7Broker) Complete(_ context.Context, _ jobs.CompleteCommand) error {
	atomic.AddInt32(&b.completeCalled, 1)
	return nil
}
func (b *azione7Broker) CompleteWithArtifacts(_ context.Context, _ jobs.CompleteWithArtifactsCommand) ([]string, error) {
	atomic.AddInt32(&b.completeWithArtifactsCalled, 1)
	return nil, nil
}
func (b *azione7Broker) Fail(_ context.Context, _ jobs.FailCommand) error {
...
var _ jobs.Broker = (*azione7Broker)(nil)
