...
// internal/capabilities/jobs/queue/registry.go) so the test compiles WITHOUT
...
// internal/capabilities/jobs/queue/registry.go. Test failure on this list
...
//
//		internal/capabilities/jobs/queue/registry.go (Wave 19 / P1-9 adder):
	...
	if len(missing) > 0 {
		t.Fatalf(
			"FAIL Policy contract (missing-policy, Wave 19 / P1-9):\n"+
				...
				"    %s\n"+
				"Fix: open internal/capabilities/jobs/queue/registry.go and add a\n"+
	...
	if len(stale) > 0 {
		...
		t.Fatalf(
			"FAIL forward-drift (Wave 19 / P1-9):\n"+
				...
				"     to internal/capabilities/jobs/queue/registry.go::Compose() WITHOUT\n"+
				"     mirroring the new Type* into the canonicalJobTypes slice of\n"+
				"     this test file. The slice mirrors the const declarations in\n"+
				"     internal/domain/job/job.go + internal/capabilities/jobs/queue/registry.go.\n"+
