...
func TestParseTimestamp_SecondsOnly(t *testing.T) {
	got, err := textutil.ParseTimestamp("45")
	if err != nil {
...
func TestParseTimestamp_MinutesSeconds(t *testing.T) {
	got, err := textutil.ParseTimestamp("2:30")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if got != 150 {
...
func TestParseTimestamp_HoursMinutesSeconds(t *testing.T) {
	got, err := textutil.ParseTimestamp("1:23:45")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if got != 5025 {
...
func TestParseTimestamp_Invalid(t *testing.T) {
	_, err := textutil.ParseTimestamp("abc")
	if err == nil {
...
func TestParseTimestamp_EdgeZero(t *testing.T) {
	got, err := textutil.ParseTimestamp("0")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if got != 0 {
...
func TestParseTimestamp_LeadingZeros(t *testing.T) {
	got, err := textutil.ParseTimestamp("00:05:00")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if got != 300 {
...
func TestParseTimestamp_Whitespace(t *testing.T) {
	got, err := textutil.ParseTimestamp("  10:30  ")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if got != 630 {
...
func TestParseTimestamp_FourParts(t *testing.T) {
	_, err := textutil.ParseTimestamp("1:2:3:4")
	if err == nil {
