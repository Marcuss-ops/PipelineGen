...
//   - clip surface (stockpipeline.StockRenderer + stockpipeline.VideoCutter + their
//     DTOs + the TransitionRegistry catalog + the stockpipeline.Clip
//     DTO + the noOp test fixtures + the 2 var _ pins
//     for the no-op concretes).
//   - source_ports.go — source-discovery narrow port (stockpipeline.ChannelLister for
