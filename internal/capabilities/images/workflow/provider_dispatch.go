...
var ErrNoGenerationProviderWired = errors.New(
	"images: GenerationProviderRegistry not wired (PR-GODOBJ-3 KILL LIST a — legacy imageGen.Generate fallback REMOVED; composition must wire NewGenerationProviderRegistry from internal/application/images/generated/provider_registry.go)",
)
