...
func TestTryRegisterModule_DuplicateFails(t *testing.T) {
	...
	require.NoError(t, tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-dup"}),
		"first register must succeed")
	err := tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-dup"})
...
func TestTryRegisterModule_FreezeFails(t *testing.T) {
	...
	require.NoError(t, tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-pre-freeze"}))
	reg.Freeze()

	err := tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-post-freeze"})
...
func TestTryRegisterModule_DistinctOK(t *testing.T) {
	...
	require.NoError(t, tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-a"}))
	require.NoError(t, tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-b"}))
	require.NoError(t, tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-c"}))
}
...
func TestTryRegisterModule_ErrorContainsSpecMarker(t *testing.T) {
	...
	_ = tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-marker"})
	err := tryRegisterModuleStrict(reg, &fakeModule{name: "fixture-marker"})
	require.Error(t, err)
