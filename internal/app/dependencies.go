...
//
// PR4d-final (June 2026): this helper is called from composition.go's
// BuildDomainBundle. It carries the vo lifecycle construction + the
// semantic tagger wiring that would otherwise inflate BuildDomainBundle.
