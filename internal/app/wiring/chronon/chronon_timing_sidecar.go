...
// ChrononMeasuredPhases is the measured phase breakdown decoded from a
// StockRust timing sidecar report.
...
// ReadChrononMeasuredPhases decodes a StockRust timing sidecar and projects
// it onto canonical render phases.
