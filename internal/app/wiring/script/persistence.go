...
func NewGenerationPersistence(repo documentadapters.ScriptRepository, log *zap.Logger) *GenerationPersistence {
	if repo == nil {
		return nil
	}
...
func (p *GenerationPersistence) Persist(ctx context.Context, input scriptgen.ScriptPersistenceInput) (int64, error) {
...
var _ scriptgen.ScriptPersistence = (*GenerationPersistence)(nil)
