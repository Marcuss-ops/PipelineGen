...
// NewRepository creates a new category channels repository.
...
func (r *Repository) Upsert(ctx context.Context, ch *models.CategoryChannel) error {
...
func (r *Repository) ListByCategory(ctx context.Context, category string) ([]*models.CategoryChannel, error) {
...
// ListAll returns all category↔channel associations, grouped by category order.
func (r *Repository) ListAll(ctx context.Context) ([]*models.CategoryChannel, error) {
	rows, err := r.db.QueryContext(ctx, `
		SELECT id, category, channel_url, channel_name, keywords, min_views, max_clip_duration, drive_folder_id,
			semantic_keywords, min_semantic_score, playlist_end, check_interval, max_videos_per_run, priority,
			lookback_days, max_segments, segment_prompt, created_at, updated_at
...
func (r *Repository) GetByID(ctx context.Context, id string) (*models.CategoryChannel, error) {
...
func (r *Repository) CountByCategory(ctx context.Context, category string) (int, error) {
	var count int
...
func scanRows(rows *sql.Rows) ([]*models.CategoryChannel, error) {
	var results []*models.CategoryChannel
	for rows.Next() {
...
func scanRow(row *sql.Row) (*models.CategoryChannel, error) {
	return scanFields(row)
}

// scanFields scans a row scanner into a CategoryChannel.
func scanFields(scanner interface{ Scan(dest ...any) error }) (*models.CategoryChannel, error) {
