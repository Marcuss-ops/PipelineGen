...
func (r *Repository) FindByYouTubeVideoID(ctx context.Context, videoID string, hasSegment bool, startSec, endSec float64) (string, error) {
...
func (r *Repository) FindByFileHash(ctx context.Context, fileHash string) (string, error) {
...
func (r *Repository) FindBySourceURL(ctx context.Context, url string) (string, error) {
...
func (r *Repository) FindByName(ctx context.Context, name string) (string, error) {
...
func (r *Repository) FindDuplicatesByYouTubeID(ctx context.Context, videoID string, excludeID string) ([]string, error) {
	videoID = strings.TrimSpace(videoID)
	if videoID == "" {
		return nil, nil
	}
