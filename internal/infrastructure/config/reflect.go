...
func processFields(v any, fn func(reflect.Value, reflect.StructTag)) {
...
// into the appropriate Go type and sets the field. On parse failure it logs
// the error so the operator knows the configuration was not applied.
func setValueFromString(field reflect.Value, valStr string) {
	...
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		...
		if err != nil {
			// silently skip — the value is a default or env var that doesn't parse
			return
		}
		field.SetInt(i)
