...
// RetryOptions configures the retry loop behaviour.
...
// DefaultRetryOptions returns a reasonable starting point for most use-cases.
...
func norm(o RetryOptions) RetryOptions {
	if o.MaxAttempts <= 0 {
		o.MaxAttempts = 3
	}
...
func sleepDuration(attemptCount int, opts RetryOptions) time.Duration {
