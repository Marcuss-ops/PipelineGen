...
//
// The verifier integration path (DeadLetterChecker wired from
// ReindexVerifier) is covered separately by verifier_test.go with a
...
// test is the load-bearing round-trip behind the ReindexVerifier
