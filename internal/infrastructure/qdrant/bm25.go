...
// BM25SchemaVersion tracks the BM25 tokenization rules (stopwords, hash function,
// vocab size, TF saturation). Bump this when the tokenization logic changes to
// force re-indexing of all assets via content hash mismatch.
const BM25SchemaVersion = "v1"
