...
func TestEnqueueIndexEvent_UsesOutboxKeyShape(t *testing.T) {
	...
	if err := d.EnqueueIndexEvent(context.Background(), nil, assetID, contentHash); err != nil {
...
func TestEnqueueIndexEvent_ProviderInferredFromAssetIDPrefix(t *testing.T) {
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			if err := d.EnqueueIndexEvent(context.Background(), nil, tc.assetID, contentHash); err != nil {
