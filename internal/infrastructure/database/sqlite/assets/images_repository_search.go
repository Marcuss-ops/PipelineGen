// Package assets — images_repository_search.go: search/list operations.
//
// Extracted from images_repository.go (July 2026, PR-IMAGES-REPO-SPLIT).
// Owns: ListImagesBySubject (deprecated), ListImages (FASE 6 canonical).
package assets
