...
// DeriveSearchTerms produces a normalized keyword list from an asset.Asset's
...
// asset.Asset's text fields + metadata_json keys. Safe on nil asset.Asset.
...
func DeriveSearchTerms(a *asset.Asset) []string {
	if a == nil {
		return []string{}
	}
