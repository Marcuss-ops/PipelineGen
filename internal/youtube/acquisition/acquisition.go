// Package acquisition (youtube/acquisition) owns the YouTube
// acquisition surface: accepts a URL, returns a DownloadedSource
// describing the local file produced.
//
