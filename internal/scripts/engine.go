...
func (e *Engine) SaveScript(ctx context.Context, rec *ScriptRecord, sections []ScriptSectionRecord, matches []ScriptStockMatchRecord) (int64, error) {
...
func (e *Engine) SaveResearchSources(ctx context.Context, scriptID int64, sources []ScriptResearchSource) error {
	if e.scriptsRepo == nil {
		return nil
	}
...
func (e *Engine) SaveOutlineSections(ctx context.Context, scriptID int64, sections []ScriptOutlineSectionRecord) error {
	if e.scriptsRepo == nil {
		return nil
	}
...
func (e *Engine) LogGeneration(ctx context.Context, scriptID int64, phase, promptHash, model string, inputWords, outputWords int, durationMs int64, retryCount int, cacheStatus, errorMsg string) {
	...
	_ = e.scriptsRepo.SaveGenerationLog(ctx, ScriptGenerationLog{
		ScriptID:    scriptID,
		Phase:       phase,
