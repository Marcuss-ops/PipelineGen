...
// Used at API boundaries. Physical-location fields (LocalPath, DriveLink, etc.)
// are mapped to deprecated struct fields for backward compatibility; once
// asset_locations is the source of truth, callers should use the locations
// repository instead.
...
// Temporary bridge for code that still requires the legacy type (clips.Repository,
// outbox.Dispatcher). Will be removed once all consumers are migrated.
