...
- queries: array of 3 short search queries in ENGLISH (2-4 words each)
- entity_queries: array of 1-2 specific names or unique entities (e.g., "Mike Tyson", "Vesuvius")
