...
func RunMediaBackfill(ctx context.Context, cfg BackfillConfig) (*BackfillReport, error) {
	...
	for _, ddl := range []string{pgmigration.MediaSchemaDDL, pgmigration.MediaVectorSurfacesDDL, pgmigration.MediaHNSWIndexesDDL, pgmigration.MediaTimestampsTimestamptzDDL, pgmigration.MediaAssetVersionsDDL, pgmigration.MediaAssetProcessingDDL} {
