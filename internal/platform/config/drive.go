...
type DriveConfig struct {
	...
	// OverlayRenderRootFolder is the parent destination for completed overlay
	// renders. The canonical publisher creates/reuses the `overlay` child
	// below this folder for videos and timing receipts.
