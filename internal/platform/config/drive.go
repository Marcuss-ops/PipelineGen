...
// DefaultOverlayRenderRootFolderID is the single Drive destination for
...
type DriveConfig struct {
	...
	// Scripts/docs generation root folder. Generated overlay renders are
	// kept here for document/script artifacts.
	ScriptsRootFolder string `yaml:"scripts_root_folder" env:"VELOX_DRIVE_SCRIPTS_ROOT" default:""`
	// OverlayRenderRootFolder is the single destination for every completed
	// overlay render. RenderingGen publishes into this exact folder through
	// the application publisher; callers never upload overlays manually or
	// choose a per-run folder.
	OverlayRenderRootFolder string `yaml:"overlay_render_root_folder" env:"VELOX_DRIVE_OVERLAY_RENDER_ROOT" default:""`
...
func (d DriveConfig) OverlayRenderFolder() string {
	if folder := strings.TrimSpace(d.OverlayRenderRootFolder); folder != "" {
		return folder
	}
	return DefaultOverlayRenderRootFolderID
}
