...
var _ imggeneration.ImageGenerator = (*ChromeImageProviderPool)(nil)
...
func (p *ChromeImageProviderPool) Generate(ctx context.Context, req imggeneration.GenerateImageRequest) (*imggeneration.GeneratedImage, error) {
