...
// contract now lives in internal/kernel/job.Store and *SQLiteStore
...
// the canonical decls to `internal/kernel/job/errors.go`; Phase A.2
...
// internal/kernel/job/errors.go) probe the SAME sentinel (same `error`
