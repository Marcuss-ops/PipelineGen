...
func TestRegistryRecordsJobStepsMetricsRelationsAndStats(t *testing.T) {
	...
	_, err = db.Exec(`
		...
		CREATE TABLE job_asset_relations (job_id TEXT NOT NULL, asset_id TEXT NOT NULL, relation TEXT NOT NULL, step_id TEXT NOT NULL DEFAULT '', ordinal INTEGER NOT NULL, created_at TEXT NOT NULL, PRIMARY KEY(job_id,asset_id,relation,step_id));
