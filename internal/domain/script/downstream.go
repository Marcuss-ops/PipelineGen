...
//	    in domain/script/downstream.go. Tipi richiesti:
...
//	                           DownstreamBoth
//	(b) Aggiungi domain/script.ManifestV2.NoInlineAssets bool (default
...
//     so domain/script does NOT import voiceover (AGENTS.md Pattern 8:
...
// voiceover.DestinationRequest so domain/script does NOT import
