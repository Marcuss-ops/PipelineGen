...
// enforce no infrastructure imports; this gate focuses on goroutines
// that bash Check 19 cannot catch. Per-area orchestrator patterns can
// be added after grep-verification during Wave 14 grandfathered-import
// drain.
