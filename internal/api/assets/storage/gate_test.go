...
// has ZERO storage entries today (storage has 0 infra imports);
// the `internal/infrastructure/` prohibition below is a forward-
// tripwire (any future infra import lands as a hard fail instead of
// leaking through to the allowlist ratchet).
