...
// started at register/Step-9). Every capability in `internal/api/**` and
// `internal/application/**` MUST expose a Build(d) signature. Direct
...
// `internal/api/routes.go::Setup()` via the `api.MediaInternalRouter`
// interface:
//
...
// `*catalogsync.Service` from `internal/application/assets/catalogsync`.
...
// `internal/api/routes.go::Setup()` for the QDRANT-001 server-to-
