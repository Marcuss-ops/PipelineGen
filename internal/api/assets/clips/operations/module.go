// Package operations is the clips sub-descriptor that owns operational
// routes: verify, fix-hash, trash, delete, reconcile, cleanup, manifest,
// and bulk tag mutations.
package operations
...
// Build composes the operations sub-descriptor.
