...
**Priorità:** P0  
**Branch unica:** `codex/pg-005-api-clips`  
**Commit suggerito:** `refactor(api): remove infrastructure imports for pg-005`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-005-api-clips`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `grep -n "internal/infrastructure" internal/api/assets/clips/bulk_upload_helpers.go internal/api/assets/clips/bulk_upload_worker.go internal/api/assets/clips/clip_action.go internal/api/assets/clips/clip_ops.go internal/api/assets/clips/handler.go internal/api/assets/clips/helpers.go internal/api/assets/clips/upload_helpers.go || true`
