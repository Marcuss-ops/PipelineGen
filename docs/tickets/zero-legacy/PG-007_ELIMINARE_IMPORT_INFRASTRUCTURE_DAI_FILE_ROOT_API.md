# PG-007 — Eliminare import infrastructure dai file root API

**Priorità:** P0  
**Branch unica:** `codex/pg-007-api-root`  
**Commit suggerito:** `refactor(api): remove infrastructure imports for pg-007`  
**Dipendenze:** PG-001
...
- `internal/api/module_core_modules.go`
...
`git checkout -b codex/pg-007-api-root`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `grep -n "internal/infrastructure" internal/api/module_core_modules.go internal/api/routes.go internal/api/server.go || true`
