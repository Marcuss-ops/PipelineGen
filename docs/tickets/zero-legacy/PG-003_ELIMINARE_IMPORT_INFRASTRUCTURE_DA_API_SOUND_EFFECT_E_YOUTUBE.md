# PG-003 — Eliminare import infrastructure da API Sound Effect e YouTube

**Priorità:** P0  
**Branch unica:** `codex/pg-003-api-soundeffect-youtube`  
**Commit suggerito:** `refactor(api): remove infrastructure imports for pg-003`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-003-api-soundeffect-youtube`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `grep -n "internal/infrastructure" internal/api/assets/soundeffect/handler.go internal/api/assets/youtube/youtube_handlers.go || true`
