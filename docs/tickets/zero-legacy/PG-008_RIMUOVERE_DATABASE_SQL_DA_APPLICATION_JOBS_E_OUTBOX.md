...
**Priorità:** P0  
**Branch unica:** `codex/pg-008-sql-jobs-outbox`  
**Commit suggerito:** `refactor(boundary): remove database sql residue for pg-008`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-008-sql-jobs-outbox`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `rg -ln '"database/sql"' internal/app/module_jobs.go internal/application/jobs internal/domain/job internal/infrastructure/database/sqlite/jobs || true`
