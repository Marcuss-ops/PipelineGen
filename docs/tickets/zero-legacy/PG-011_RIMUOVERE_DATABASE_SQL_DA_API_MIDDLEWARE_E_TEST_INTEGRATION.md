# PG-011 — Rimuovere database/sql da API middleware e test integration

**Priorità:** P0  
**Branch unica:** `codex/pg-011-sql-api-middleware-tests`  
**Commit suggerito:** `refactor(boundary): remove database sql residue for pg-011`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-011-sql-api-middleware-tests`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `rg -ln '"database/sql"' internal/api/common internal/api/middleware internal/app internal/infrastructure/database || true`
