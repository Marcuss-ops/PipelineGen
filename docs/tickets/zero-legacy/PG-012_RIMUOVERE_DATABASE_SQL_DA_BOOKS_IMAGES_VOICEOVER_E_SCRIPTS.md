# PG-012 — Rimuovere database/sql da books images voiceover e scripts

**Priorità:** P0  
**Branch unica:** `codex/pg-012-sql-remaining-application`  
**Commit suggerito:** `refactor(boundary): remove database sql residue for pg-012`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-012-sql-remaining-application`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `rg -ln '"database/sql"' internal/app internal/application/books internal/application/images internal/application/scripts internal/application/voiceover internal/infrastructure/database || true`
