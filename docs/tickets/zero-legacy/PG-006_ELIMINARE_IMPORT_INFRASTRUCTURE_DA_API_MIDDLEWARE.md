# PG-006 — Eliminare import infrastructure da API Middleware

**Priorità:** P0  
**Branch unica:** `codex/pg-006-api-middleware`  
**Commit suggerito:** `refactor(api): remove infrastructure imports for pg-006`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-006-api-middleware`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `grep -n "internal/infrastructure" internal/api/middleware/admin_token.go internal/api/middleware/middleware_feature_flags.go internal/api/middleware/middleware_logger.go internal/api/middleware/middleware_middleware.go internal/api/middleware/middleware_ratelimit.go || true`
