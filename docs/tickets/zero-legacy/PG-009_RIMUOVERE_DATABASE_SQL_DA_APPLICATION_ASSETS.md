...
**Priorità:** P0  
**Branch unica:** `codex/pg-009-sql-assets-application`  
**Commit suggerito:** `refactor(boundary): remove database sql residue for pg-009`  
**Dipendenze:** PG-001
...
- `internal/app/assets_adapters.go`
...
`git checkout -b codex/pg-009-sql-assets-application`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `rg -ln '"database/sql"' internal/app/assets_adapters.go internal/application/assets internal/domain/asset internal/infrastructure/database/sqlite/assets || true`
