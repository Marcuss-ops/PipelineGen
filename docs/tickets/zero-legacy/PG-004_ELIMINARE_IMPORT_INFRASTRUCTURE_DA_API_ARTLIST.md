# PG-004 — Eliminare import infrastructure da API Artlist

**Priorità:** P0  
**Branch unica:** `codex/pg-004-api-artlist`  
**Commit suggerito:** `refactor(api): remove infrastructure imports for pg-004`  
**Dipendenze:** PG-001
...
`git checkout -b codex/pg-004-api-artlist`. Non creare altre branch.

### C. Catturare la baseline verificabile

- `grep -n "internal/infrastructure" internal/api/assets/artlist/artlist_handlers.go || true`
