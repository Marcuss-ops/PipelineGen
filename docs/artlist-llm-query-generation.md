...
┌─────────────────────────────────────────────────────────────────┐
│                   Ollama LLM Call                              │
│  - Model: gemma4:e4b (or configured model)                    │
...
- `gen`: Ollama generator instance (uses gemma4:e4b or configured model)
...
**Current Model:** `gemma4:e4b` (located via `ollama list`)
...
1. Primary model (e.g., gemma4:e4b)
