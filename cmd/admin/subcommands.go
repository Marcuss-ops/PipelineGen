...
var commandRegistry = map[string]commandHandler{
	...
	"check-db-cartoon-files":         runCheckDBCartoonFiles,
	...
	"download-kids-music":            runDownloadKidsMusic,
	...
	"render-beluga-short":            runRenderBelugaShort,
	"render-fish-short":              runRenderFishShort,
