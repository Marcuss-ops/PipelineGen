...
var KnownLimitResidueInventory = []KnownLimitResidueEntry{
	...
	{File: "internal/application/assets/providers/stock/enrichment/handler.go", Line: 247, Archetype: KnownLimitArchetypeParamVar, Reason: "HandleJob(ctx, job *appjobs.Job, ...) — if len(job.Payload) > 0"},
	{File: "internal/application/assets/providers/stock/enrichment/handler.go", Line: 248, Archetype: KnownLimitArchetypeParamVar, Reason: "HandleJob(ctx, job *appjobs.Job, ...) — json.Unmarshal(job.Payload, ...)"},
