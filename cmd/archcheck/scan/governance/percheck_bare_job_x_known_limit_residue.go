...
var KnownLimitResidueInventory = []KnownLimitResidueEntry{
	...
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 31, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — if !r.registry.Has(job.Type) where job is local *Job return of dispatch.Claim"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 33, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — r.log.Error (\"claimed unsupported job type — releasing\") zap.String(\"job_type\", job.Type)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 34, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — zap.String(\"job_id\", job.ID)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 36, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — fmt.Errorf(\"%w: %s\", ErrHandlerNotRegistered, job.Type)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 60, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — go r.renewLoop(renewCtx, tools, job.ID, renewErrs)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 69, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — r.log.Warn \"lease renewal failed — failing the job\" zap.String(\"job_id\", job.ID)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 94, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — r.log.Warn \"worker Progress emit failed (FASE 0.2 silent-drop rewrite)\" zap.String(\"job_id\", job.ID)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 95, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — zap.String(\"job_type\", job.Type)"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 98, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — observability.WorkerProgressEmittedTotal.WithLabelValues(job.Type, \"error\").Inc()"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 99, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — observability.WorkerProgressErrorsTotal.WithLabelValues(job.Type, \"broker_emit_failed\").Inc()"},
	{File: "internal/capabilities/jobs/worker/runner_execute.go", Line: 101, Archetype: KnownLimitArchetypeLocalVar, Reason: "runLease(...) — observability.WorkerProgressEmittedTotal.WithLabelValues(job.Type, \"success\").Inc()"},
	...
	{File: "internal/capabilities/jobs/queue/errors.go", Line: 110, Archetype: KnownLimitArchetypeStringLiteral, Reason: "errors.New(\"appjobs.Service: repo is required ... canonical-job.JobBroker-port ...\") — token inside errors.New literal"},
}
