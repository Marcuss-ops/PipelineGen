...
func main() {
	...
	parentID := flag.String("parent", "1OAAf5dawAppdopsgCq1yHFGPUXCI9Vbk", "The Artlist root folder ID to scan on Drive")
	flag.Parse()
	...
	// 1. List all folders inside the Artlist root on Drive
