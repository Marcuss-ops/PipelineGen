...
var routeDescriptions = map[string]string{
	...
	// Note: the legacy /api/script-docs/* paths (generate, preview, modes,
	// association-candidates) were removed in June 2026 when the script
	// module was refactored. The unified entry point is now
	// /api/script/generate-from-clips (see internal/module/scriptflow.go).
