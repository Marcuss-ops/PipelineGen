...
# Scenario behavior is split into source-only phase helpers. They receive the
# runner's manifest/global contract and do not alter the public entrypoint.
# shellcheck disable=SC1091
source "$DIR/lib/report.sh"
# shellcheck disable=SC1091
source "$DIR/lib/concurrency.sh"
# shellcheck disable=SC1091
