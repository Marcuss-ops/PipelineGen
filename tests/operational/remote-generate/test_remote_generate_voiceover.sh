#!/usr/bin/env bash
# tests/operational/remote-generate/test_remote_generate_voiceover.sh
#
...
#     ./tests/operational/remote-generate/test_remote_generate_voiceover.sh
#
# Companion di tests/operational/remote-generate/test_remote_generate_clips.sh (clip-driven) e
# tests/operational/remote-generate/test_remote_generate.sh (text-driven). Stesso protocollo
...
#
# ITEM 6: questo script + tests/operational/worker-integration/main.go::runVoiceoverMode
