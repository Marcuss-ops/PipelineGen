#!/usr/bin/env bash
# tests/operational/remote-generate/test_remote_generate.sh
#
...
#
# Uso:
#   API_URL=https://pipeline.example.com TOKEN=il_tuo_token ./tests/operational/remote-generate/test_remote_generate.sh
