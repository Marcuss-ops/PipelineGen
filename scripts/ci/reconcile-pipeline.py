    ...
    phases = [
        ...
        run_phase(
            ...
            [
                ...
                "./internal/capabilities/assets/deletion/reconciler",
                "./internal/capabilities/jobs",
                "./internal/platform/drive",
                "./internal/platform/sqlite/outboxevents",
                "./internal/capabilities/assets/providers/stock/enrichment",
                "./internal/capabilities/assets/providers/stock/stockpipeline",
                "./internal/capabilities/jobs/completion",
                "./internal/capabilities/outbox",
                "./internal/platform/sqlite/outbox",
            ],
            args.timeout,
        ),
        run_phase(
